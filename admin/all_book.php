...
<TD style="color:darkgreen" WIDTH='25%'><b><u>VIEW MORE</u></b></TD>	
				...
				echo "<td><img src='../$row[b_img]' width='50'/>";
									...
									echo '<td><a href="process_del_book.php?b_id='.$row['b_id'].'"><img src="images/drop.png" ></a></td>';
									echo '<td><a href="update_book.php?b_id='.$row['b_id'].'"><img src="images/edit.png" ></a></td>';
                                    echo '<td><a href="process_view_book.php?b_id='.$row['b_id'].'"><img src="images/more.png" ></a>
